        ...
        <div className="section__padding app__bg" id="work">
            ...
            <div className="project__card">
                ...
                <ProjectCard
                    ...
                    info={"Developed the front-end of the Gericht Restaurant website, focusing on modern UI design and responsive layouts. Learned key concepts of React and CSS while building the project, refining component structure and styling skills."}
                    year={"2025"}
                    role={"Front-end Developer"}
                    technologies={"React"}
                    gitPath={"https://github.com/MittakolaPranay/React_Restaurent"}
                />
                ...
                <ProjectCard
                    ...
                    gitPath={"https://github.com/MittakolaPranay/Library_Management_System"}
                />
