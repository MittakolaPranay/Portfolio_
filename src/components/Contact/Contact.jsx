    ...
    return <div id="contact" className="app__bg section__padding">
        ...
        <div className="app__wrapper">
            <div className="app__wrapper_heading">
                <SecondaryHeading heading={"Let’s connect"} para={`Say hello at mittakolap@gmail.com. <br />For more info, here's my <a href = "\https://pranay-77.netlify.app/MyResume.pdf" class = "a__link">Resume</a>`}/>
            </div>
